          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:py-24">
            <div className="animate-slide">
              <span className="inline-flex items-center gap-2 rounded-full bg-mint px-3 py-1.5 text-xs font-semibold text-primary ring-1 ring-primary/20">
                <span className="size-2 animate-bob rounded-full bg-primary" /> Now watching 12
                routes from TPE 桃園
              </span>
            ...
            <div className="relative animate-slide [animation-delay:120ms]">
              <div className="rounded-[28px] bg-white/90 p-5 ring-1 ring-border">
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full bg-blossom px-3 py-1 text-xs font-bold text-accent">
                    ▼ 21%
                  </span>
                </div>
            ...
            {[
              {
                ...
                text: "text-primary",
                title: "Set your route 設定航線",
                body: "Pick any city you fly out of 桃園 (TPE).",
                delay: "60ms",
              },
              {
                n: "2",
                ...
                ring: "ring-accent/20",
                text: "text-accent",
                title: "Set a target 設定目標價",
                body: "Tell us the price that feels like a deal.",
                delay: "140ms",
              },
              {
                n: "3",
                ...
                ring: "ring-primary/20",
                text: "text-primary",
                title: "Get the email 收到通知",
                body: "We ping you the instant it drops below your line.",
                delay: "220ms",
              },
            ].map((s) => (
              <div
                key={s.n}
                className={`rounded-3xl ${s.bg} animate-slide p-6`}
                style={{ animationDelay: s.delay }}
              >
                <span
                  className={`grid size-10 place-items-center rounded-full bg-white font-display font-semibold ${s.text} ring-1 ${s.ring}`}
                >
                  {s.n}
                </span>
            ...
            <div className="rounded-[28px] bg-sky/15 p-7 ring-1 ring-sky/25">
              ...
              <ul className="mt-4 space-y-2 text-sm font-semibold text-foreground">
                <li className="flex gap-2">
                  <span className="text-primary">•</span> 2 routes + unlimited fare alerts 免費
                </li>
                <li className="flex gap-2">
                  <span className="text-primary">•</span> Unlimited routes + price-history graphs
                  無上限
                </li>
                <li className="flex gap-2">
                  <span className="text-primary">•</span> NT$ 120 / month · cancel anytime
                </li>
              </ul>
              <Link
                to="/sign-in"
      ...
      <footer className="mt-8 border-t border-border">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-5 py-10 md:flex-row md:items-center">
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm font-semibold text-muted-foreground">
            ...
            <a href="#routes" className="transition hover:text-foreground">
              Popular routes
            </a>
            <a href="#pricing" className="transition hover:text-foreground">
              Pricing
            </a>
            <Link to="/sign-in" className="transition hover:text-foreground">
              Sign in / 登入
            </Link>
          </nav>
          <p className="text-xs font-medium text-muted-foreground">
            © 2026 Flight Price Notifier. Made for deal-hunters.
          </p>
        </div>
      </footer>
    </div>
